...
-- CreateEnum
CREATE TYPE "ContentType" AS ENUM ('VIDEO', 'SLIDES', 'ARTICLE', 'OTHER');
...
-- CreateIndex
CREATE UNIQUE INDEX "Course_pricingId_key" ON "Course"("pricingId");
...
-- AddForeignKey
ALTER TABLE "Course" ADD CONSTRAINT "Course_pricingId_fkey" FOREIGN KEY ("pricingId") REFERENCES "Pricing"("id") ON DELETE SET NULL ON UPDATE CASCADE;
